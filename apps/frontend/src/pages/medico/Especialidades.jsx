...
export default function Especialidades() {
  ...
  const especialidades = [
    ...
    },
    {
      ...
      nombre: "Neurología",
      medicos: 8,
      descripcion: "Especialidad médica que trata los trastornos del sistema nervioso central, periférico y autónomo.",
      icono: "🧠",
      activa: true
    },
    {
      ...
      nombre: "Oftalmología",
      medicos: 6,
      descripcion: "Especialidad médica que estudia las enfermedades de los ojos y su tratamiento, incluyendo el globo ocular y sus anexos.",
      icono: "👁️",
      activa: true
    },
    {
    ...
    },
    {
      ...
      medicos: 20,
      descripcion: "Atención médica integral y continua para individuos, familias y comunidades.",
      icono: "🩺",
      activa: true
    }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600">Especialidades disponibles en nuestro centro médico</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-slate-900">{totalEspecialidades}</div>
          ...
          <div className="mt-2 text-xs font-medium text-slate-500">Total Especialidades</div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-slate-600">En todas las especialidades</div>
            </div>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-lg font-bold text-slate-900">{masPopular.nombre}</div>
              <div className="text-sm text-slate-600">{masPopular.medicos} médicos</div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {especialidades.map((especialidad) => (
          <Card key={especialidad.id} className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div className="text-3xl">{especialidad.icono}</div>
              <div className="text-right">
                <div className="text-sm font-medium text-slate-600">{especialidad.medicos} médicos</div>

        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <h1 className="text-2xl font-bold text-gray-800">Clinix</h1>
            </div>
            <nav className="flex space-x-4">
              ...
              <Link
                to="/admin"
                className={`flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium ${isActive("/admin")
                    ? "bg-blue-100 text-blue-700"
                    : "text-gray-600 hover:text-gray-900"
                  }`}
              >
              ...
              <Link
                to="/medico"
                className={`flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium ${isActive("/medico")
                    ? "bg-blue-100 text-blue-700"
                    : "text-gray-600 hover:text-gray-900"
                  }`}
              >

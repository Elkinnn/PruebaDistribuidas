...
// GET /hospitales/:hospitalId/especialidades?page=&size=
router.get('/hospitales/:hospitalId/especialidades', async (req, res) => {
  try {
...
router.post('/hospitales/:hospitalId/especialidades/:especialidadId', async (req, res) => {
  try {
...
router.delete('/hospitales/:hospitalId/especialidades/:especialidadId', async (req, res) => {
  try {
